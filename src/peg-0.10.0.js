        ...
        var compiler = {
          ...
          passes: {
            check: {
              ...
              reportDuplicateLabels: require(
                "./passes/report-duplicate-labels",
              ),
              reportInfiniteRecursion: require(
                "./passes/report-infinite-recursion",
              ),
              reportInfiniteRepetition: require(
                "./passes/report-infinite-repetition",
              ),
            },
            transform: {
 ...
 */
        function generateBytecode(ast) {
          ...
          function buildCall(functionIndex, delta, env, sp) {
            ...
            return [op.CALL, functionIndex, delta, params.length].concat(
              params,
            );
          }
          ...
          function buildSemanticPredicate(code, negative, context) {
            var functionIndex = addFunctionConst(
          ...
          var generate = visitor.build({
            ...
            sequence: function (node, context) {
              function buildElementsCode(elements, context) {
                ...
                if (elements.length > 0) {
                  processedCount = node.elements.length -
                    elements.slice(1).length;
                  ...
                  if (context.action) {
                    ...
                    return buildSequence([op.WRAP, node.elements.length], [
                      op.NIP,
                    ]);
                  }
                }
            ...
            "class": function (node) {
              ...
              parts = "[" +
                arrays.map(node.parts, function (part) {
                  return part instanceof Array
                    ? '["' + js.stringEscape(part[0]) + '", "' +
                      js.stringEscape(part[1]) + '"]'
      ...
      6: [function (require, module, exports) {
        ...
        function generateJS(ast, options) {
          ...
          function generateTables() {
            if (options.optimize === "size") {
              return [
                ...
                "peg$bytecode = [",
                indent2(
                  arrays.map(ast.rules, function (rule) {
                    return 'peg$decode("' +
                      js.stringEscape(
                        arrays.map(
                          rule.bytecode,
          ...
          function generateRuleHeader(ruleNameCode, ruleIndexCode) {
            ...
            if (options.cache) {
              parts.push([
                "var key    = peg$currPos * " + ast.rules.length + " + " +
                ruleIndexCode + ",",
          ...
          function generateInterpreter() {
            ...
            function generateCondition(cond, argsLength) {
              ...
              return [
                "ends.push(end);",
                "ips.push(ip + " + baseLength + " + " + thenLengthCode + " + " +
                elseLengthCode + ");",
                "",
                "if (" + cond + ") {",
            ...
            function generateCall() {
              ...
              return [
                "params = bc.slice(ip + " + baseLength + ", ip + " +
                baseLength + " + " + paramsLengthCode + ");",
            ...
            parts.push(
              indent2(generateRuleHeader("peg$ruleNames[index]", "index")),
            );
            ...
            parts.push(
              indent2(generateRuleFooter("peg$ruleNames[index]", "stack[0]")),
            );
            parts.push("}");
          ...
          function generateRuleFunction(rule) {
            ...
            var stack = {
              ...
              pop: function (n) {
                ...
                if (n === void 0) {
                  ...
                  values = arrays.map(
                    arrays.range(this.sp - n + 1, this.sp + 1),
                    s,
                  );
                  this.sp -= n;
              ...
              while (ip < end) {
                switch (bc[ip]) {
                  ...
                  case op.TEXT: // TEXT
                    parts.push(
                      stack.push(
                        "input.substring(" + stack.pop() + ", peg$currPos)",
                      ),
                    );
                    ip++;
                    break;
                  ...
                  case op.FAIL: // FAIL e
                    parts.push(stack.push("peg$FAILED"));
                    parts.push(
                      "if (peg$silentFails === 0) { peg$fail(" + c(bc[ip + 1]) +
                        "); }",
                    );
                    ip += 2;
                    break;
                  ...
                  case op.LOAD_SAVED_POS: // LOAD_SAVED_POS p
                    parts.push(
                      "peg$savedPos = " + stack.index(bc[ip + 1]) + ";",
                    );
                    ip += 2;
                    break;
                  ...
                  case op.RULE: // RULE r
                    parts.push(
                      stack.push(
                        "peg$parse" + ast.rules[bc[ip + 1]].name + "()",
                      ),
                    );
                    ip += 2;
                    break;
            ...
            if (options.trace) {
              parts.push([
                "  var " +
                arrays.map(arrays.range(0, stack.maxSp + 1), s).join(", ") +
                ",",
                "      startPos = peg$currPos;",
              ].join("\n"));
            } else {
          ...
          function generateToplevel() {
            ...
            if (options.optimize === "size") {
              startRuleIndices = "{ " +
                ...
                " }";
              startRuleIndex = asts.indexOfRule(
                ast,
                options.allowedStartRules[0],
              );
      ...
      }, { "../../grammar-error": 14, "../asts": 1, "../visitor": 13 }],
      ...
      }, { "../utils/arrays": 17, "../utils/objects": 19 }],
        ...
        function peg$parse(input, options) {
          ...
          var peg$FAILED = {},
            ...
            peg$c31 = function (expression) {
               ...
               */
              return expression.type === "labeled" ||
